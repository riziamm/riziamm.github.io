...
- Research featured on the **cover of *Robotica*** (2022).
...
- **06/2023** — Gave a mentor talk at Women* in Physics, Astronomy & Engineering (WiPAE), ANU's professional development session. [Session](https://www.eventbrite.com/e/all-you-ever-wanted-to-know-about-job-applications-tickets-659877700967)
- **05/2023** — Joined ANU as a Research Fellow in the Neuroinformatics Group.
- **12/2022** — Submitted the [final Technical Report: *Autonomous Aerial Power Plant Inspection in GPS-denied Environments*](https://www.osti.gov/biblio/1905874) for our DOE project (US DOE Office of Fossil Energy, Office of Clean Energy Systems, FE-22).
- **12/2022** — New preprint: *Deep Learning based Aerial Intelligent Crack Detection in Infrastructure using Computer Vision at the Edge*. [Authorea](https://www.authorea.com/users/566716/articles/613352-intelligent-crack-detection-in-infrastructure-using-computer-vision-at-the-edge)
- **12/2022** — Submitted my PhD dissertation. [PDF](https://www.proquest.com/docview/2771312039?pq-origsite=gscholar&fromopenview=true)
- **11/2022** — Defended my PhD dissertation.
- **08/2022** — Gave the closing presentation for our DOE-funded project *Autonomous Aerial Power Plant Inspection in GPS-denied Environments*.
- **07/2022** — Our work was featured on the cover of the journal *Robotica*. [Issue](https://www.cambridge.org/core/journals/robotica/issue/C7E6E90F3873894447C930F18A4DD71C)
- **10/2021** — Our paper *Autonomous aerial flight path inspection using advanced manufacturing techniques* was accepted in *Robotica*. [Article](https://www.cambridge.org/core/journals/robotica/article/autonomous-aerial-flight-path-inspection-using-advanced-manufacturing-techniques/FCF7EE1742354F0319F8ADD7606C80BD)
- **2021** — Began teaching as PhD Instructor (Course Convenor, Engineering Computation), Department of Aerospace & Mechanical Engineering, UTEP. [Department](https://www.utep.edu/engineering/mechanical/)
- **05/2021** — Presented our UAV trajectory-generation work at the DOE Crosscutting Research and Advanced Energy Systems Project Review Meeting. [Our work](https://netl.doe.gov/sites/default/files/netl-file/21SC_Abad.pdf)
- **01/2020** — Presented at AIAA SciTech 2020, Orlando: *A CAM/AM-based Trajectory Generation Method for Aerial Power Plant Inspection in GPS-denied Environments*. [Paper](https://arc.aiaa.org/doi/abs/10.2514/6.2020-0858)
- **04/2019** — Presented our UAV trajectory-generation work at the 2019 Project Review Meeting for Crosscutting Research, Pittsburgh, PA. [Meeting](https://netl.doe.gov/events/19CREEGTPG)
